 ...
 * DoneTODO: Redistribute responsibilities by moving behaviours closer to the data they manipulate.
 *
 */
public class Bank {
    ...
    // DoneTODO: remove navigation code
    public void changePayrollProcessingDate(String date, String staffCategory) {
        payroll.getStaffCategoryPaySchedule(staffCategory).setPayDay(date); // DoneTODO: remove this navigation code
    }
