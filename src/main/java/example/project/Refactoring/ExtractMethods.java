...
public class ExtractMethods {
     ...
     * DoneTODO: complete `foo_after_refactoring()` method below using the refactoring.
     */
    ...
    public static void foo_after_refactoring() {
        // DoneTODO: uncomment the following lines and complete missing methods
    ...
    private static int[] initialiseArray(int size) {
